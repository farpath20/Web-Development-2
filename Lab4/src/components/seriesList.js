...
const SeriesList = (props) => {
    ...
    async function next(){
        ...
        props.history.replace({ pathname: `/series/page/${pgNum}`})
                ...
                <CardMedia
                  ...
                  <CardContent>
                    ...
                    <Typography variant='body2' color='textSecondary' component='p'>
                      {show.startYear
                        ? (`Start Year: ${show.startYear}`)
                        : 'No Start Year'}
                    </Typography>
                    <Typography variant='body2' color='textSecondary' component='p'>
                      {show.endYear&&show.endYear<2023
                        ? (`End Year: ${show.endYear}`)
                        : 'Current or No Info'}
                    </Typography>
                    <Typography variant='body2' color='textSecondary' component='p'>
                      {show.description
                        ? (("Description: "+show.description).replace(regex, '').substring(0, 139) + '...')
                        : 'No Description'}
                         <span>...More Info</span>
                    </Typography>
